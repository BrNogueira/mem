 ...
 *   https://datatables.net/download/#bs/dt-1.10.12/af-2.1.2/b-1.2.2/b-print-1.2.2/r-2.1.0/rr-1.1.2/sc-1.4.2/se-1.2.0
 *
 * Included libraries:
 *   DataTables 1.10.12, AutoFill 2.1.2, Buttons 1.2.2, Print view 1.2.2, Responsive 2.1.0, RowReorder 1.1.2, Scroller 1.4.2, Select 1.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortDescending": ": Ative para ordernar em ordem decrescente."
			},
			 ...
			 *    } );
			 */
			"sEmptyTable": "A tabela não contém dados.",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Mostrando 0 à 0 de 0 itens.",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Filtrado de _MAX_ itens totais.)",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.12/af-2.1.2/b-1.2.2/b-print-1.2.2/r-2.1.0/rr-1.1.2/sc-1.4.2/se-1.2.0",
