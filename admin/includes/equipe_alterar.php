...
<span data-active="equipe"></span>

<?php if(isset($_SESSION['login'])){
	
	$titulo = 'Equipe';
	
	$pagina_anterior = 'equipe';
	
	$table = $update_table = 'equipe';
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6">
						<div class="form-group">
				            ...
				            <input type="text" name="informacao" value="<?php echo $result['informacao']; ?>" class="form-control"/>
				        </div>
			        </div>
					<div class="col-xs-12 col-sm-6">
						<div class="form-group">
							<label>Imagem <small>[ Dimensões: 600x800px ]</small></label>
